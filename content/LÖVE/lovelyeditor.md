...
- All UI elements can be ordered as you like
- Multiple layout support, make your own!
- Tab system so you can open multiple editors at once
- Multiple tile selection
- Saving and loading map files from disk
- Tilemaps can be either saved to the map file or referenced via relative path to the project
